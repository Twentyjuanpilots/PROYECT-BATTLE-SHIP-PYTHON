...
#Recomendamos correrlo en la terminal local para que luzca mucho mejor
...
#En esta funcion guardamos las reglas, con un pequeño condicional para que el usuario elija si verlas o no
def reglas():
    clear()
    mostrar_titulo()    #Por esstetica limpiamos la terminal y mostramos el titulo para que no se vea el mensaje de esperar_tecla
    while True:     #lo ponemos en while para que se ejecute mientras no se ingrese una condicion valida
            elegir = input("""
                                        ⚓¿𝐓𝐄 𝐆𝐔𝐒𝐓𝐀𝐑Í𝐀 𝐂𝐎𝐍𝐎𝐂𝐄𝐑 𝐋𝐀𝐒 𝐑𝐄𝐆𝐋𝐀𝐒? 𝐂𝐀𝐌𝐀𝐑𝐀𝐃𝐀 (𝐒𝐈/𝐍𝐎) ⚓
                   """)
            elegir = elegir.upper() #Para reducir la cantidad de condiciones "OR" ponemos todo lo que el usuario ponga en mayuscula  
            if(elegir == "SI" or elegir == "SI."):    #ponemos como condicion tanto SI como SI. No mas por si hay un chistoso 
                print ("""
            𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨 𝐚𝐥 𝐣𝐮𝐞𝐠𝐨 𝐝𝐞 𝐛𝐚𝐭𝐚𝐥𝐥𝐚 𝐧𝐚𝐯𝐚𝐥:
            ...
            𝟏𝟎) 𝐈𝐧𝐝𝐢𝐜𝐚𝐝𝐨𝐫 𝐝𝐞 𝐞𝐫𝐫𝐨𝐫 (⛔) 𝐄𝐬𝐭𝐞 𝐢𝐧𝐝𝐢𝐜𝐚𝐝𝐨𝐫 𝐚𝐩𝐚𝐫𝐞𝐜𝐞 𝐜𝐮𝐚𝐧𝐝𝐨 𝐟𝐚𝐥𝐥𝐚𝐬 𝐮𝐧 𝐭𝐢𝐫𝐨 𝐨 𝐞𝐥 𝐜𝐨𝐧𝐭𝐫𝐢𝐧𝐜𝐚𝐧𝐭𝐞 𝐟𝐚𝐥𝐥𝐚 𝐬𝐮 𝐭𝐢𝐫𝐨
                ...
                𝐄𝐥 𝐣𝐮𝐞𝐠𝐨 𝐭𝐞𝐫𝐦𝐢𝐧𝐚 𝐜𝐮𝐚𝐧𝐝𝐨 𝐮𝐧𝐨 𝐝𝐞 𝐥𝐨𝐬 𝐝𝐨𝐬 𝐛𝐚𝐧𝐝𝐨𝐬 𝐪𝐮𝐞𝐝𝐞 𝐬𝐢𝐧 𝐛𝐚𝐫𝐜𝐨𝐬, 𝐲 𝐬𝐞 𝐠𝐚𝐧𝐚 𝐭𝐞𝐧𝐢𝐞𝐧𝐝𝐨 𝐦í𝐧𝐢𝐦𝐨 𝟏 𝐛𝐚𝐫𝐜𝐨 𝐚 𝐟𝐥𝐨𝐭𝐞
                        ...
                        """)        #Imprimos las reglas cuando si
                time.sleep(5)
                print("""
                                                        ⚓¡𝐁𝐔𝐄𝐍𝐀 𝐒𝐔𝐄𝐑𝐓𝐄, 𝐌𝐀𝐑𝐈𝐍𝐄𝐑𝐎!⚓
                      """)
                time.sleep(2)
                esperar_tecla()         #Las partes de esperar_tecla() son meramente estetica no cambia en mucho el codigo
                clear()
                break
            elif(elegir == "NO" or elegir == "NO."):
                print("""
                                                        ⚓¡𝐁𝐔𝐄𝐍𝐀 𝐒𝐔𝐄𝐑𝐓𝐄, 𝐌𝐀𝐑𝐈𝐍𝐄𝐑𝐎!⚓
                      """)
                time.sleep(4)
                clear()
                break
            elif(elegir == "" or " " in elegir):    #Cuado no se ingresa nada o se detecta un espacio se imprime este mensaje y se vuelve a preguntar
                print("""
                                                ⚓ 𝐃𝐄𝐁𝐄𝐒 𝐈𝐍𝐆𝐑𝐄𝐒𝐀𝐑 "𝐒𝐈" 𝐎 "𝐍𝐎". 𝐒𝐈𝐍 𝐄𝐒𝐏𝐀𝐂𝐈𝐎𝐒 ⚓
                    """) 
                time.sleep(4)
                clear()
                mostrar_titulo()    #Limpiamos y mostramos titulo de nuevo para que no se nos llene la terminal de mensajes
            elif(elegir != "SI" and elegir != "NO" and elegir != "SI." and elegir != "NO."): #Si no sucede nada de lo anterior, asumimos que el valor ingresado es invalido
                print("""
...
def start():
    ...
    time.sleep(2)  # de la librearia time llamamos a la funcion sleep, para que espere 2 segundo antes de ejecutar el siguiente codigo
    esperar_tecla()  # llamos a la funcion que hace que espere un espacio para continuar
    reglas()   # La ponemos en start() para que forme parte de lo que se ejecuta al iniciar el juego
...
""")
    ...
    for i in range(len(tablero_usuario)):
            print(f"""                                            
                              {i + 1} | {tablero_usuario[i]}    |   {i + 1} | {tablero_ataque[i]}
...
def pedir_cordenadas():
    ...
    while True:
        letras = input("""
                                            ⚓𝐈𝐍𝐆𝐑𝐄𝐒𝐄 𝐋𝐀𝐒 𝐂𝐎𝐎𝐑𝐃𝐄𝐍𝐀𝐃𝐀𝐒 𝐃𝐄𝐒𝐄𝐀𝐃𝐀𝐒, (𝐄𝐉𝐄𝐌𝐏𝐋𝐎 𝐃𝟏)⚓:
                        """)
        letras = letras.upper()
        if (
            ...
            and (letras[1] in condicion_y)  # el segundo caracter corresponde a un numero
        ):
            return letras
        elif(letras == "" or " " in letras):
            print("""
                                                    ❗𝐍𝐎 𝐇𝐀𝐒 𝐈𝐍𝐆𝐑𝐄𝐒𝐀𝐃𝐎 𝐂𝐎𝐎𝐑𝐃𝐄𝐍𝐀𝐃𝐀𝐒 ❗
                  """)

        elif(letras != condicion_x or letras !=condicion_y):  # si no se ingresa una cordenada, se le avisa al usuario y se vuevle a pedir
            print("""
...
def traductor_cordenadas(val):
    ...
    if type(val) == tuple:
        ...
        for i in range(len(condicion_x)):   # iteramos 5 veces
            if condicion_x[i] == val[0]:   # si encontramos la misma letra que ingreso el usuario en la condicion_x, significa que encontramos el indice para esa letra en especi
...
def posiciones_IA():
    ...
    while contador > 0:  # mientras ayan barcos que los siga creando
        ...
        time.sleep(1)
    print("""
                                            ⚓ ¡𝐄𝐋 𝐎𝐏𝐎𝐍𝐄𝐍𝐓𝐄 𝐇𝐀 𝐏𝐎𝐒𝐈𝐂𝐈𝐎𝐍𝐀𝐃𝐎 𝐓𝐎𝐃𝐎𝐒 𝐒𝐔𝐒 𝐁𝐀𝐑𝐂𝐎𝐒!⚓
          """)
    return IA
...
def posiciones_usuario():
    ...
    while contador > 0:
        if (contador == 1): # si el contador es igual a uno que diga barco en vez de barcos
            print(f"""
                                                ⛴  ¡𝐓𝐄 𝐐𝐔𝐄𝐃𝐀 {contador} 𝐁𝐀𝐑𝐂𝐎 𝐏𝐎𝐑 𝐏𝐎𝐒𝐈𝐂𝐈𝐎𝐍𝐀𝐑! ⛴
                  """)
        else:
            print(f"""
                                                ⛴ ¡𝐓𝐄 𝐐𝐔𝐄𝐃𝐀𝐍 {contador} 𝐁𝐀𝐑𝐂𝐎𝐒 𝐏𝐎𝐑 𝐏𝐎𝐒𝐈𝐂𝐈𝐎𝐍𝐀𝐑!⛴
                  """)
        ...
        if tablero[i_1][i_2] != "🚢":  # Si no ay un barco ay si se puede dibujar
            tablero[i_1][i_2] = "🚢"
            contador -= 1
            mostrar_tablero(tablero)  # mostramos el tablero con el cambio recien ingreado
        else:   # si ay un barco, avisarle al usuario que ingreso un lugar que ya fue ingresado y volver al bucle
            mostrar_tablero(tablero)
            print("""
                                                    ❗𝐘𝐀 𝐇𝐀𝐒 𝐈𝐍𝐆𝐑𝐄𝐒𝐀𝐃𝐎 𝐀𝐍𝐓𝐄𝐒 𝐄𝐒𝐓𝐀 𝐏𝐎𝐒𝐈𝐂𝐈𝐎𝐍❗
                  """)
...
def battelship():
    ...
    tablero_user = posiciones_usuario()  # guardamos las posiciones de los barcos del usuario
    ...
    while True:
        ...
        tablero_ataque, index, condicion = verificar_ataque(tablero_IA, tablero_ataque, posiciones_ataque_usuario(tablero_IA))
        # la funcion nos devuelve el tablero con los cambios
        mostrar_tablero(tablero_user, tablero_ataque) # mostrar_tablero toma dos parametros y el tablero de ataque lo recibimos de la funcion anterior
        if condicion:   # la funcion tambien devuelve una condicion de la que hablamos en la linea 248 para imprimir si destruyo o no un barco
            ...
            print(
                f"""
                                💥¡𝐇𝐀𝐒 𝐀𝐓𝐀𝐂𝐀𝐃𝐎 𝐋𝐀𝐒 𝐂𝐎𝐎𝐑𝐃𝐄𝐍𝐀𝐃𝐀𝐒 {traductor_cordenadas(index)}, 𝐘 𝐃𝐄𝐒𝐓𝐑𝐔𝐈𝐒𝐓𝐄 𝐔𝐍 𝐁𝐀𝐑𝐂𝐎 𝐃𝐄 𝐓𝐔 𝐎𝐏𝐎𝐍𝐄𝐍𝐓𝐄💥
                """
            )
        else:
            print(
                f"""
                                         🌊¡𝐇𝐀𝐒 𝐀𝐓𝐀𝐂𝐀𝐃𝐎 𝐋𝐀𝐒 𝐂𝐎𝐎𝐑𝐃𝐄𝐍𝐀𝐃𝐀𝐒 {traductor_cordenadas(index)} . 𝐏𝐄𝐑𝐎 𝐂𝐀𝐘Ó 𝐀𝐋 𝐀𝐆𝐔𝐀!🌊
                """ )
        ...
        print("""
                                            ⚔️ ¡𝐓𝐔 𝐎𝐏𝐎𝐍𝐄𝐍𝐓𝐄 𝐒𝐄 𝐄𝐒𝐓Á 𝐏𝐑𝐄𝐏𝐀𝐑𝐀𝐍𝐃𝐎 𝐏𝐀𝐑𝐀 𝐀𝐓𝐀𝐂𝐀𝐑! . . . ⚔️
              """)
        time.sleep(3)
        clear()
        # --------------------------------------------------------------------------------------------------------------------------
        ...
        tablero_user, index, condicion = verificar_ataque(tablero_user, tablero_user, posiciones_ataque_IA(tablero_user))
        mostrar_tablero(tablero_user, tablero_ataque) # volvemos a mostrar el tablero con el cambio del tablero del usuario, osea el ataque
        # con la condicion la utilizamos igual que con el ataque del usuario pero con mensajes diferentes
        if condicion:
            print(f"""
                                    💥¡𝐓𝐔 𝐎𝐏𝐎𝐍𝐄𝐍𝐓𝐄 𝐇𝐀 𝐃𝐄𝐒𝐓𝐑𝐔𝐈𝐃𝐎 𝐔𝐍𝐎 𝐃𝐄 𝐓𝐔𝐒 𝐁𝐀𝐑𝐂𝐎𝐒 𝐄𝐍 𝐋𝐀𝐒 𝐂𝐎𝐎𝐑𝐃𝐄𝐍𝐀𝐃𝐀𝐒 {traductor_cordenadas(index)}!💥
                """)
        else:
            print(f"""
                                    🌊¡𝐓𝐔 𝐎𝐏𝐎𝐍𝐄𝐍𝐓𝐄 𝐀𝐓𝐀𝐂Ó 𝐄𝐍 𝐋𝐀𝐒 𝐂𝐎𝐎𝐑𝐃𝐄𝐍𝐀𝐃𝐀𝐒 {traductor_cordenadas(index)}. 𝐏𝐄𝐑𝐎 𝐂𝐀𝐘Ó 𝐀𝐋 𝐀𝐆𝐔𝐀!🌊
            """)
    ...
    # esperamos 5 segundo para que se lea el mensaje de si ganaste o perdiste
    time.sleep(5)
...
def volver_a_empezar():
    while True:
        ...
        desicion = input("""
                         ...
                         """)
        desicion = desicion.upper() #convertimos el string a mayúsculas (tambien se puede hacer con lower)
        if(desicion == "SI"): #si el usuario responde SI, volvemos a llamar a la funcion battelship para que se vuelva a ejecutar el juego
            battelship()
            volver_a_empezar()
            break
        elif(desicion == "NO"): #si el usuario responde NO, salimos del bucle e imprimimos el mensaje de despedida
            mostrar_titulo()
            print("""
